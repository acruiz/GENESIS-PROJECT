...
for ($data = 2004; $data <= 2010; $data++) {
	$url = "http://www.christophemaetz.fr/philatelie/basededonnees/?p=ad-fr&d=".$data;
	$ch = curl_init();
...
// implode(' ',explode('&nbsp;',$y[1]))
$consulta = "INSERT INTO ad_fr(any,imatge,yvert,michel,scott,edifil,id_pais) VALUES('$any','$img','".$y[1]."','".$m[1]."','".$s[1]."','".$e[1]."','ad-fr')";
